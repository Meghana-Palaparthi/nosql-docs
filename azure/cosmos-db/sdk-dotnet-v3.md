---
title: SQL .NET Standard API, SDK and Resources
...
Different sub versions of .NET SDKs are available under the 3.x.x version. **The minimum recommended version is 3.57.0**.
