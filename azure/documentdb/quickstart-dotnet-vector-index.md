...
This executes 9 searches (3 algorithms × 3 metrics) and displays a comparison table showing latency, similarity scores, and top results for each combination. See the [sample code](https://github.com/Azure-Samples/documentdb-samples/tree/main/ai/select-algorithm-dotnet) for the full comparison runner.
